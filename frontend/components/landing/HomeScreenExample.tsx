      ...
      <Container>
        <div className="grid grid-cols-12 items-start gap-x-6 gap-y-8">
          <div className="col-span-12 lg:col-span-5">
            <h2 className="ed-section">
              Find companies, not just research one
            </h2>
            <p className="ed-body mt-5 max-w-[52ch]">
              The deal screen filters every US-listed filer on figures taken
              from their own SEC filings. Set a revenue band, a margin floor, a
            ...
            <p className="mt-4 max-w-[52ch] text-[0.9375rem] leading-[1.55] text-ink-secondary">
              ...
              amortisation. Where a company does not report D&amp;A separately
              it is left blank, because filling it in would be a guess.
            </p>
            <p className="mt-5">
              <Link
                href="/screen"
