...
export const about: About = {
  ...
  bio: [
    ...
    "Investment Intelligence is where all of that meets. It takes the kind of analysis I'd run on a buyout target and applies it to any US-listed company: fundamentals, valuation, a five-year LBO model, and an investment memo, with the formula and source shown behind every number so you can check it yourself. Take a look around, and feel free to get in touch.",
  ],
  highlights: [
    {
